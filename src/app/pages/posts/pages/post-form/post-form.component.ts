...
import { IAcademicLevel, IAxis, IPostDetail, IPostForm, ISubjectWithAxis, PostDetail, PostFile } from 'src/app/pages/posts/models/post.model';
...
export class PostFormComponent extends Unsubscriber implements OnInit {
    ...
    private createPost(): void {
        this.loading = true;
        const userId = this.authService.user?.detail?.id ?? null;
