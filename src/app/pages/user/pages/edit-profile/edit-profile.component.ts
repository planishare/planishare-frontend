...
import { LocationsService } from 'src/app/pages/user/services/locations.service';
import { OccupationsService } from 'src/app/pages/user/services/occupations.service';
import { UsersService } from 'src/app/pages/user/services/users.service';
import { CommonSnackbarMsgService } from 'src/app/shared/services/common-snackbar-msg.service';

import { IUserDetail, IUserForm } from 'src/app/pages/user/models/user.model';
import { ICommune, IRegionWithCommunes } from 'src/app/pages/user/models/location.model';
